...
public class SeminarService {
    ...
    private final UserSeminarRepository userSeminarRepository;


    public Page <ListSeminarResponse>listSeminar(Pageable pageable, Integer limit) {
        PageRequest pageRequest = PageRequest.of(pageable.getPageNumber(),limit);
        Page<Seminar> seminarPage = seminarRepository.findAll(pageRequest);
